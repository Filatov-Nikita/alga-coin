    ...
    <div class="tw-fixed tw-bottom-0 tw-mb-4">
      ...
      <div class="profile tw-flex tw-flex-col tw-justify-center">
        ...
        >
          <template #default>
            <span
              class="tw-flex tw-gap-1.5 tw-items-center tw-justify-center text tw-text-xs"
            >
              <svg
                width="20"
                height="20"
              ...
              >
                <path
                  d="M12.4118 2H5.52941C4.68824 2 4 2.72 4 3.6V16.4C4 17.28 4.68824 18 5.52941 18H12.4118C13.2529 18 13.9412 17.28 13.9412 16.4V14.8H12.4118V16.4H5.52941V3.6H12.4118V5.2H13.9412V3.6C13.9412 2.72 13.2529 2 12.4118 2Z"
                  fill="#BEC3FF"
                />
                <path
                  d="M11.5782 12.872L10.5 14L6.67647 10L10.5 6L11.5782 7.128L9.60529 9.2H17V10.8H9.60529L11.5782 12.872Z"
                  fill="#BEC3FF"
                />
              </svg>
              {{ t("log-out") }}
